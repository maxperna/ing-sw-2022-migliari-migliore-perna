...
public class IslandList {
    ...
    /**
     * method used to add a Node containing an ArrayList of IslandTiles in an initially doubly linked list, when the list has all 12 Nodes, the last element points to the end, making this list circular
     * @param island that will be part of the node (the node can be seen as a superclass of IslandTile, containing all references and methods to make a DCLL
     */
    public void addIslandNode(IslandTile island) {
